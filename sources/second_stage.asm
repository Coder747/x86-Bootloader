...
;********************************* Main Program **************************************
      ...
      call get_key_stroke           ; Wait for key stroke to jump to second boot stage
      call check_a20_gate
      ...
      call get_key_stroke    
      call disable_pic
      call bios_cls                 ;clear the screen before going to the third stage (long mode)
      call load_idt_descriptor      ;We cannot use bios interrupts after this function call
...
first2mb db 'First 2MB mapped successfully',13,10,0
video_x db 0
video_y db 0
...
LongModeEntry:
    ...
    jmp 0x10000       ;jump to third_stage.asm
