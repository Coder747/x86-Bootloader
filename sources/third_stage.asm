...
bus_loop:
    ...
    device_loop:
        ...
        function_loop:
            call get_pci_device
            inc byte [function]         ;function,bus,device,offset are defined as 0 (db 0)
            cmp byte [function],8
        jne device_loop
...
call page_2          ;map all physical memory

mov rsi,mapped      ;confirm mapping by printing  
call video_print
...
;*******************************************************************************************************************
      ...
      %include "sources/includes/third_stage/page_table_2.asm"
      %include "sources/includes/third_stage/memory_test.asm"
...
start_location   dq  0x0  ; A default start position (Line # 8)
    ...
    mapping    db 'Mapping...',13,0
    mapped db 'Mapped all physical memory',13,0
